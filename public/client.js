...
const EFFECT_INITIAL_PAUSE_MS = 1400;
const EFFECT_BETWEEN_PAUSE_MS = 900;
...
function showTurnCardEffect(effect, holdMs, done) {
  ...
  // Use the user's card-flip sound at the actual flip, then play the card's reward/penalty sound.
  ...
  effectTimeouts.push(soundDelay, t1, t2);
}
